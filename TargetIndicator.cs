...
class TargetIndicator : MonoBehaviour
{
    ...
    void Start()
    {
        var instance = TargetIndicatorsCameraScript.Instance();
        if (instance)
        {
...
class TargetIndicatorsCameraScript : MonoBehaviour
{
    public static TargetIndicatorsCameraScript Instance()
    {
        Camera mc = Camera.main;
        if (!mc)
        {
            Debug.LogWarning("TargetIndicatorsCameraScript: Couldn't find main camera.");
            return null;
        }
        var instance = mc.GetComponent<TargetIndicatorsCameraScript>();
        if (!instance)
        {
            instance = mc.gameObject.AddComponent<TargetIndicatorsCameraScript>();
        }
        return instance;
    }
    ...
    public List<TargetIndicator> _trackedObjects = new List<TargetIndicator>();

    public void Register(TargetIndicator om)
    {
    ...
    void OnGUI()
    {
        ...
        {
            TargetIndicator marker = _trackedObjects[i];
